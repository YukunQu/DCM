...
def uniformSampling(pairs_df,sampleNum):
    ...
    index = sampledAngle.index
    pairs_droped = pairs_df.drop(index,axis=0)    
    return sampledAngle, pairs_droped
...
def megBlcok(mapDir):
    ...
    blockConditionPath = os.path.join(mapPath[0],mapPath[1],mapPath[2])

...
imagePoolDir = r'D:\File\PhD\Development cognitive map\experiment\task\dcm_day1\Image_pool/game1'
mapSetsDir =  r'D:\File\PhD\Development cognitive map\experiment\task\dcm_day1\map_set'
levels=5
setNum=10

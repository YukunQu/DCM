...
from condition.utils import genPairRelation
...
def alignVSmisalign(testAngles,ytrue_test,omega_estimate):
    ...
    #     angleActivation = []
    #     for binNum,y in zip(anglebinNum,ytrue_test):
    #         if binNum == num:
    #             angleActivation.append(y)
    #     meanActivation = sum(angleActivation)/len(angleActivation)
    #     binsActivation.append(meanActivation)

...
# load atlas
atlas_img = load_img(r'/mnt/data/DCM/tmp/aparc_atlas/aparc+aseg.nii.gz')
...
#html_view = plotting.view_surf(fsaverage.infl_right, texture,threshold=0.01,
...
"""
brain.add_data(vtx_data, min=0.2,max=0.4,thresh=0, colormap="rocket", alpha=.8)
#%%

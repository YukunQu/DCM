...
stats_path = r'/mnt/workdir/DCM/BIDS/derivatives/Nipype/hexagon/specificTo6/test_set/EC/testset{}/{}/{}/spmT_0001.nii'
roi_path = r'/mnt/workdir/DCM/BIDS/derivatives/Nipype/hexagon/defROI/{}/EC_func_roi.nii'
save_path = r'/mnt/workdir/DCM/BIDS/derivatives/Nipype/hexagon/betas/subjects_ifold_testset_EC_tvalue.csv'
...
data = participants_data.query('(usable==1)&(game1_acc>0.70)&(Age>18)')

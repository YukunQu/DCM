...
#mask = r'/mnt/workdir/DCM/result/ROI/Group/mPFC.nii.gz'
mask = r'/mnt/workdir/DCM/docs/Mask/VMPFC/VMPFC_nilearn.nii.gz'
radius = (2, 2, 2)
...
peak_mask = image.get_data(image.load_img(r'/mnt/workdir/DCM/result/ROI/Group/mPFC.nii.gz'))
#peak_mask[peak_mask<5]=0
bin_tmap_thr_peak_spere = np.logical_and(peak_mask.astype(bool), bin_tmap_thr)
...
bin_tmap_thr_peak_spere_img.to_filename("/mnt/workdir/DCM/result/ROI/Group/F-test_mPFC_thr2.3.nii.gz")

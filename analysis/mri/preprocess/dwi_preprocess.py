...
fmriprep_dir = r'/mnt/workdir/DCM/BIDS/derivatives/qsiprep/qsiprep'
...
#%%
command_qsiprep = ' qsiprep-docker {} {} participant --participant_label {} --output-resolution 2 --recon_input {} --recon_spec {} --fs-license-file {} --freesurfer-input {} -w {} --custom_atlases {} --nthreads 100 --gpus all'
...
for subj in sub_list:
    freesurfer_license = r'/mnt/data/license.txt'
    command = command_qsiprep.format(bids_dir,out_dir,subj,recon_input,recon_spec,freesurfer_license,freesurfer_input,work_dir,path2atlas)

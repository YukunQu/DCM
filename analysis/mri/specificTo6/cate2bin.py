...
for sub in subjects:
    ...
    phi_dir = r'/mnt/workdir/DCM/BIDS/derivatives/Nipype/hexonM2Long/specificTo6/Phi'
    phi_data = pd.read_csv(pjoin(phi_dir, 'trainset1_estPhi.csv'))
    ...
    sub_activity = sub_activity.query("(run_id==3)or(run_id==4)")

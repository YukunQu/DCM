...
for sub in subject_list:
    for run_id in range(1,7):
        data_dir = r'/mnt/data/DCM/derivatives/fmriprep_volume_v22_nofmap'
        input.append(pjoin(data_dir,
                      fr'{sub}/fsl_smooth0/{sub}_task-game1_run-0{run_id}_space-T1w_desc-preproc_bold.ica/'
...
cmd_list = list_to_chunk(cmd_list,40)

...
def cal_diff(sub,contrast, game1_cmap_temp, game2_cmap_temp):
    ...
    save_dir = r'/mnt/workdir/DCM/BIDS/derivatives/Nilearn/game2/hexagon_sum/Setall/6fold/sub-{}/zmap'.format(sub) # look out
...
task_contrast = {'base_spct': ['M1', 'M2_corr', 'decision_corr', 'correct_error'],
                 'hexagon_spct': ['M1', 'M2_corr', 'decision_corr','hexagon'],
...
game1_cmap_temp = rf'/mnt/data/DCM/result_backup/2023.5.14/Nilearn/game1/{task}'+'/Setall/6fold/sub-{}/zmap/{}_zmap.nii.gz'
game2_cmap_temp = rf'/mnt/data/DCM/result_backup/2023.5.14/Nilearn/game2/{task}'+'/Setall/6fold/sub-{}/zmap/{}_zmap.nii.gz'

...
def cal_diff(sub,game1_cmap_temp, game2_cmap_temp):
    ...
    save_dir = r'/mnt/workdir/DCM/BIDS/derivatives/Nilearn/game2/distance_diff/Setall/6fold/sub-{}/zmap'.format(sub) # look out
    os.makedirs(save_dir, exist_ok=True)
    diff_img.to_filename(os.path.join(save_dir, '{}_zmap.nii.gz'.format('distance')))
...
game1_cmap_temp = r'/mnt/data/DCM/result_backup/2023.5.14/Nilearn/game1/distance_spct/Setall/6fold/sub-{}/zmap/distance_zmap.nii.gz'
game2_cmap_temp = r'/mnt/data/DCM/result_backup/2023.5.14/Nilearn_replace/game2/distance_replace_spct/Setall/6fold/sub-{}/zmap/M2_corrxdistance_zmap.nii.gz'

...
container_path = 'hexagon/specificTo6/training_set/trainsetall/group/{}/Age_plus_Acc'.format(sub_type)  # look out
...
onesamplettestdes.inputs.covariates = [dict(vector=age, name='Age', centering=1),
                                       dict(vector=game1_acc, name='game1_acc', centering=1)]
...
# specify contrast
condition_names = ['mean','Age','game1_acc']
...
analysis2nd = Workflow(name='work_2nd',
                       base_dir='/mnt/workdir/DCM/BIDS/derivatives/Nipype/working_dir/hexagon/{}/Age_plus_Acc'.format(sub_type))

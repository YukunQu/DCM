...
container_path = 'hexagon/specificTo6/training_set/trainsetall/group/{}/Age'.format(sub_type)  # look out
...
analysis2nd = Workflow(name='work_2nd',
                       base_dir='/mnt/workdir/DCM/BIDS/derivatives/Nipype/working_dir/hexagon/{}/Age'.format(sub_type))

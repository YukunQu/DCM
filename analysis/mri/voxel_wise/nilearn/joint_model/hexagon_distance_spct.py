...
def load_ev(event_path):
    ...
    event_condition = event.query("trial_type in ['M1','M2_corr','M2_error','decision_corr','decision_error','sin','cos']")
...
def run_glm(task,subj,ifold):
    if task == 'game1':
        configs = {'TR': 3.0, 'task': 'game1', 'glm_type': 'hexagon_distance_spct',

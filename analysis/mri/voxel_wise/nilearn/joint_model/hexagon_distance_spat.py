...
def run_glm(task,subj):
    if task == 'game1':
        ifold = 6
        configs = {'TR': 3.0, 'task': 'game1', 'glm_type': 'hexagon_distance_spat',
        ...
        ifold = 6
        configs = {'TR': 3.0, 'task': 'game2', 'glm_type': 'hexagon_distance_spat',
                   'run_list': [1, 2],
                   'func_dir': r'/mnt/workdir/DCM/BIDS/derivatives/fmriprep_volume_fmapless/fmriprep',
                   'event_dir': r'/mnt/workdir/DCM/BIDS/derivatives/Events',
...
if __name__ == "__main__":
    ...
    for chunk in subjects_chunk:
        results_list = Parallel(n_jobs=36)(delayed(run_glm)(task,subj) for subj in chunk)
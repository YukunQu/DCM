...
def set_contrasts(design_matrix):
    #contrast_name = ['M1','M2_corr','decision_corr','decision_error','eucd','manhd','value']
    contrast_name = ['M1','M2_corr','decision_corr','decision_error','distance','value']
    # base contrast
    contrasts_set = {}
...
if __name__ == "__main__":
    ...
    for chunk in subjects_chunk:
        results_list = Parallel(n_jobs=40)(delayed(run_glm)(task,subj,ifold) for subj in chunk)

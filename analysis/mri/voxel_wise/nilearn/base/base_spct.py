...
def set_contrasts(design_matrix):
    contrast_name = ['M1','M2_corr','decision_corr','decision_error']
    # base contrast
    contrasts_set = {}
...
if __name__ == "__main__":
    ...
    for chunk in subjects_chunk:
        results_list = Parallel(n_jobs=100)(delayed(run_glm)(task,subj) for subj in chunk)

...
def run_glm(task, subj, ifold):
    if task == 'game1':
        configs = {'TR': 3.0, 'task': 'game1', 'glm_type': 'cv_train_hexagon_distance_value_spct',
        ...
        configs = {'TR': 3.0, 'task': 'game2', 'glm_type': 'cv_train_hexagon_distance_value_spct',
                   'run_list': [1, 2],
                   'func_dir': r'/mnt/workdir/DCM/BIDS/derivatives/fmriprep_volume_fmapless/fmriprep',
                   'event_dir': r'/mnt/workdir/DCM/BIDS/derivatives/Events',

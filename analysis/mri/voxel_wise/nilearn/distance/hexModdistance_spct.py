...
def set_contrasts(design_matrix):
    contrast_name = ['M1','M2_corr','M2_error','decision_corr','decision_error',
                     'alignxdistance','misalignxdistance']
    # base contrast
    contrasts_set = {}
    ...
    # advanced contrast
    contrasts_set['hexModdistance'] = contrasts_set['alignxdistance'] - contrasts_set['misalignxdistance']
    return contrasts_set


def run_glm(task,subj,ifold):
    if task == 'game1':
        configs = {'TR': 3.0, 'task': 'game1', 'glm_type': 'hexModdistance_spct',
        ...
        configs = {'TR': 3.0, 'task': 'game2', 'glm_type': 'hexModdistance_spct',
                   'run_list': [1, 2],
                   'func_dir': r'/mnt/workdir/DCM/BIDS/derivatives/fmriprep_volume_fmapless/fmriprep',
                   'event_dir': r'/mnt/workdir/DCM/BIDS/derivatives/Events',

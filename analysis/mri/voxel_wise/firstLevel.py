...
def firstLevel_noPhi_separate(subject_list,set_id,runs,ifold,configs):
    ...
    mask_img1 = r'/mnt/data/Template/tpl-MNI152NLin2009cAsym/tpl-MNI152NLin2009cAsym_res-02_desc-brain_mask.nii'
    mask_img2 = r'/mnt/workdir/DCM/docs/Mask/res-02_desc-brain_mask.nii'
    ...
    susan.inputs.inputnode.mask_file = [mask_img1]*6

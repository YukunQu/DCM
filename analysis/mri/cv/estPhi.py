...
def estimate_game1_cv_phi(workdir):
    ...
    roi = r'/mnt/data/DCM/result_backup/2023.5.14/Nilearn/game1/cv_train_hexagon_spct/OFC_thr3.1.nii.gz'
    mask = load_img(roi)
    ...
    # set output
    savepath = os.path.join(workdir,f'estPhi_ROI-OFC_{method}_cv.csv')
...
def estimate_game1_whole_trials_phi(workdir):
    ...
    # set ROI
    roi = pjoin(workdir,'OFC_thr3.1.nii.gz')
    mask = load_img(roi)
    ...
    # set output
    savepath = os.path.join(workdir,f'estPhi_ROI-OFC_{method}_trial-all.csv')
...
if __name__ == "__main__":
    workingdir = r'/mnt/data/DCM/result_backup/2023.5.14/Nilearn/game1/cv_train_hexagon_spct'

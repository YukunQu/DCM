...
class Game1EV_spat_distance(Game1EV_spat):
    ...
    def game1ev_spat_distance(self, ifold):
        m1ev = self.genM1ev()
        m2ev = self.genM2ev()
        deev = self.genDeev()
        pmod_sin, pmod_cos = self.genpm(m2ev, ifold)
...
def gen_sub_event(task, subjects, ifolds=range(4, 9)):
    if task == 'game1':
        ...
        template = {
            ...
            'save_dir': r'/mnt/workdir/DCM/BIDS/derivatives/Events/{}/hexagon_spat_distance/sub-{}/{}fold',
        ...
        template = {
            ...
            'save_dir': r'/mnt/workdir/DCM/BIDS/derivatives/Events/{}/hexagon_separate_phases_all_trials/sub-{}/{}fold',
            'event_file': 'sub-{}_task-{}_run-{}_events.tsv'}
    else:
        ...
        for ifold in ifolds:
            ...
            for idx in runs:
                ...
                if task == 'game1':
                    ...
                    event_data = event.game1ev_spat_distance(ifold)
                elif task == 'game2':
                    event = Game2EV_spat(behDataPath)
                    event_data = event.game2ev_spat(ifold)
                else:
                    raise Exception("The type of task is wrong.")

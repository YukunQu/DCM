...
if __name__== "__main__":
    ...
    for sub in subjects[48:65]:
        ...
        sub_game2train_list = [game2file  for game2file in sub_game2train_list if '.csv' in game2file]
